// 分享小程序C端
export const shareC = '小程序找工作，就上猎多多！机会多，面试多！'

// 分享小程序B端
export const shareB = '招聘，就上猎多多！心仪候选人直接开撩！'
...
export const sharePosition = (res) => {
	let txtList = [
		'【工作易得，知音难觅，壮士约乎？】推荐你试试这个职业机会~',
		'【我不想懂天文地理，我只想懂你~】推荐你试试这个职业机会~',
		'【公司的进口零食得找个人清一清了】推荐你试试这个职业机会~',
		'【我看你骨骼精奇，是块耐磨的料子】推荐你试试这个职业机会~',
		'【好看的和能干的，都欢迎来开撩哦】推荐你试试这个职业机会~',
		'【把握住缘分，搞不好能成为同事~】推荐你试试这个职业机会~',
		'【我这么Nice的招聘官已经不多见了！】推荐你试试这个职业机会~'
	]
	let random = Math.floor((Math.random()*txtList.length))
	return txtList[random]
}
...
// 分享公司
export const shareCompany = '正在招聘，马上约面，极速入职！我在猎多多等你！'
